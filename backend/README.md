...
## Project Structure
    ...
    ├── testapiautosetting_126986  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_126986`
...
2. Clone this repo and `cd testapiautosetting_126986`
